...
import selenium.parent.SeleniumBaseClass;

public class LambdaTest_Sample extends SeleniumBaseClass {
	...
	public void formPageValidation() throws IOException {
		...
		Assert.assertEquals(formattedOutput, "89", "slider mismatch happened");
